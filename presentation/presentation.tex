...
\plain{Annexes}
  ...
  \begin{frame}[fragile, noframenumbering]
    \inputminted[linenos, breaklines, autogobble, fontsize=\small, firstline=76, lastline=88]{python}{../elgamal.py}
  \end{frame}
  ...
  \begin{frame}[fragile, noframenumbering]
    \inputminted[linenos, breaklines, autogobble, fontsize=\small, firstline=128, lastline=144]{python}{../SecretSanta.py}
  \end{frame}

  \begin{frame}[fragile, noframenumbering]
    \inputminted[linenos, breaklines, autogobble, fontsize=\small, firstline=145, lastline=164]{python}{../SecretSanta.py}
  \end{frame}

  \begin{frame}[fragile, noframenumbering]
    \inputminted[linenos, breaklines, autogobble, fontsize=\small, firstline=165, lastline=184]{python}{../SecretSanta.py}
  \end{frame}
